...
class BinanceTrader(ExchangeAdapter):
    """Minimal Binance adapter placeholder."""

    def __init__(self, api_key: str, api_secret: str) -> None:
        self.api_key = api_key
        self.api_secret = api_secret
        logging.info("BinanceTrader initialisiert")
    ...
    def place_order(
        ...
        **kwargs: Any,
        ...
        raise NotImplementedError("Binance API nicht implementiert")
